    ...
    def __init__(self, aug_params=None, split='training',
        ...
        for scene in os.listdir(image_root):
            ...
            if split != 'test':
                ...
                # self.flow_list += sorted(glob(osp.join(flow_root, scene, '*.png')))
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training',
        ...
        images1 = sorted(glob(osp.join(root, 'image_2_npy/*_10.npy')))
        images2 = sorted(glob(osp.join(root, 'image_2_npy/*_11.npy')))
...
class DarkT(FlowDataset):
    def __init__(self, aug_params=None, split='training',
                 root='datasets/DarkT',
                 ):
        super(DarkT, self).__init__(aug_params, sparse=True,
                                    )
        if split == 'testing':
            self.is_test = True
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root='datasets/HD1K'):
        ...
        while 1:
            ...
            images = sorted(glob(os.path.join(root, 'hd1k_input', 'image_2_npy/%06d_*.npy' % seq_ix)))
    ...
    def __init__(self, aug_params=None,
        ...
        for split in splits:
            ...
            for image_dir in image_dirs:
                ...
                image_paths = sorted(glob(osp.join(image_dir, '*.png')))
