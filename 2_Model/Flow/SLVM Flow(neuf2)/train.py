...
from NeuFlow.neuflow import NeuFlow, SLVMFlow
...
def get_args_parser():
    ...
    # dataset
    parser.add_argument('--checkpoint_dir', default='checkpoints1', type=str)
    parser.add_argument('--dataset_dir', default=None, type=str)
    parser.add_argument('--stage', default='darkt', type=str)  # things
    parser.add_argument('--val_dataset', default=['darkt'], type=str, nargs='+')
    # default=['things', 'sintel']

    # training
    parser.add_argument('--model', default='SLVMFlow', type=str, help='choose your flow model: SLVMFlow or neuflow')
...
def main(args):
    ...
    # model
    model = SLVMFlow().to(device) if args.model is 'SLVMFlow' else NeuFlow().to(device)
    ...
    while total_steps < args.num_steps:
        ...
        for i, sample in enumerate(train_loader):
            ...
            if total_steps % 100 == 0:
                print('Steps: ' + str(total_steps), 'EPE: ' + str(round(metrics['epe'], 3)),
                      'MAG: ' + str(round(metrics['mag'], 3)), optimizer.param_groups[-1]['lr'])
            ...
            if total_steps % args.val_freq == 0:
                ...
                if ['kitti', 'darkt'] in args.val_dataset:
